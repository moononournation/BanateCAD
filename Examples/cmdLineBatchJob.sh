...
# xvfb-run -a -s "-screen 0 800x600x24" meshlabserver -i Examples/moon_lamp_0.75_inches.stl -o Examples/stl/moon_lamp_0.75_inches_Y170.stl -s Examples/mlx/MeshLabRotateY170.mlx
...
xvfb-run -a -s "-screen 0 800x600x24" meshlabserver -i Examples/moon_lamp_2.5_inches.stl -o Examples/stl/moon_lamp_2.5_inches_Y160.stl -s Examples/mlx/MeshLabRotateY160.mlx
