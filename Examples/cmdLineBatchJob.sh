...
# meshlabserver -i moonLamp6inches.stl -o stl/moonLamp6inches.stl

# meshlabserver -i moonLamp2inches.stl -o stl/moonLamp2inchesY30.stl -s mlx/MeshLabRotateY30.mlx
