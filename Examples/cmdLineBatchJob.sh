...
# xvfb-run -a -s "-screen 0 800x600x24" meshlabserver -i Examples/moon_lamp_98mm.stl -o Examples/stl/moon_lamp_98mm_Y170.stl -s Examples/mlx/MeshLabRotateY170.mlx
